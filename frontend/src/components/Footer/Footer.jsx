...
const socialLinks = [
    {
        path: "https://www.youtube.com/babjo",
        icon: <AiFillYoutube className="group-hover:text-white w-4 h-5" />,
    },
    {
        path: "https://www.github.com/babjo",
        icon: <AiFillGithub className="group-hover:text-white w-4 h-5" />,
    },
    {
        path: "https://www.instagram.com/babjo",
        icon: <AiOutlineInstagram className="group-hover:text-white w-4 h-5" />,
    },
    {
        path: "https://www.linkedin.com/babjo",
...
const quickLinks02 = [
    {
        path: "/find-more-about-school",
        display: "Find more about the school",
    },
    {
        path: "/",
    ...
    return <footer className="pb-16 pt-10">
        <div className="container">
            <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
                <div>
                    <img src={logo} alt="" />
                    <p className="text-[16px] leading-7 font-[400] text-textColor mt-4">Copyright © {year} developed by Best Choice Digital Inc., all right reserved.</p>
